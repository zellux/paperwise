...
SYSTEM_PROMPT = (
    ...
    "suggested_title must be specific enough to distinguish the document "
    "and must not be only the document type. Include useful identifying "
    "details such as sender/issuer, subject, person, property, project, "
    "account or reference number, date, period, location, product/service, "
    "amount, or visible title text when present. "
