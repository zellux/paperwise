...
def test_user_preferences_round_trip() -> None:
    ...
    try:
        ...
        assert put_response.json()["preferences"]["grounded_qa_max_documents"] == 9
        ...
        assert get_saved.json()["preferences"]["grounded_qa_max_documents"] == 9
